...
Route::group(['prefix' => 'auth', 'middleware' => ['prevent_going_back']], function ($route) {
    $route->get('/', [AuthController::class, 'index'])->name('auth.index');
    $route->post('/login', [AuthController::class, 'login'])->name('auth.login');
    $route->get('/logout', [AuthController::class, 'logout'])->name('auth.logout');
});

Route::group(['prefix' => 'admin', 'middleware' => ['check_role:admin', 'prevent_going_back']], function ($route) {
    ...
    $route->group(['prefix' => 'requested_books'], function ($route) {
...
Route::group(['prefix' => 'user', 'middleware' => ['prevent_going_back', 'check_role:user']], function ($route) {
    $route->group(['prefix' => 'book'], function ($route) {
